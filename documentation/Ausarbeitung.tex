...
\newcommand{\MyTopic}{STG~--~Kernelsprache und Ausführungsmodell nicht-strikter funktionaler Programmiersprachen}        % Thema (Unterüberschrift)
% =======================================================
...
\input{chapters/02-basics}
\input{chapters/03-stg-language}
